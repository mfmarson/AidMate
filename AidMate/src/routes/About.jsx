const About = () => (
  <main>
    <p>
      ...
      <br></br>
      <br></br>
      Tadashi, Baymax's creator, understood that the core of effective help lies
      in simple, clear instructions. That’s exactly what AidMate offers –
      ...
      <br></br>
      <br></br>
      Our team dreams big, and who knows, maybe one day we'll create a real-life
      Baymax. For now, we're excited to bring you this first step in making
      first aid accessible and straightforward for everyone.
    </p>
  </main>
);
